...
grep -q 'M00_GOVERNANCE_BLOCKED' docs/prep/M01_HANDOFF_RECORD.md || fail 'historical governance handoff evidence missing'
...
grep -q 'M00_GOVERNANCE_BLOCKED' docs/prep/M01_FIRST_VERTICAL_SLICE_CANDIDATE.md || fail 'historical vertical admission block evidence missing'
...
printf 'M01 EXIT READINESS: PASS / PHASE %s\n' "$phase"
