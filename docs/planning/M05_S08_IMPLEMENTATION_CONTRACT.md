...
Status: `IMPLEMENTATION AUTHORIZED / CONTRACT LOCKED / NOT YET IMPLEMENTED`
Tracking issue: #123. Parent epic: #34.
...
At this boundary the request subject reference is the canonical S01 subject UUID string. Organization and subject must match the opening context. Archive intake ID and exact original object must match the submission. Case summaries never contain original bytes or extracted values.
